...
open class SurveyViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TableCellDataDelegate {
   ...
   public func registerTableViewCells() {
      ...
      let otherOptionNib = UINib(nibName: "OtherOptionTableViewCell", bundle: frameworkBundle)
      tableView!.register(otherOptionNib, forCellReuseIdentifier: "other_option")
      let textFieldNib = UINib(nibName: "TextFieldTableViewCell", bundle: frameworkBundle)
      tableView!.register(textFieldNib, forCellReuseIdentifier: "text_field")
      let questionNib = UINib(nibName: "DynamicLabelTableViewCell", bundle: frameworkBundle)
      tableView!.register(questionNib, forCellReuseIdentifier: "question")
      let segmentNib = UINib(nibName: "SelectSegmentTableViewCell", bundle: frameworkBundle)
      tableView!.register(segmentNib, forCellReuseIdentifier: "segment_select")
      let rowHeaderNib = UINib(nibName: "TableRowHeaderTableViewCell", bundle: frameworkBundle)
      tableView!.register(rowHeaderNib, forCellReuseIdentifier: "row_header")
      let rowSelectNib = UINib(nibName: "TableRowTableViewCell", bundle: frameworkBundle)
      tableView!.register(rowSelectNib, forCellReuseIdentifier: "row_select")
      let dynamicLabelTextFieldNib = UINib(nibName: "DynamicLabelTextFieldTableViewCell", bundle: frameworkBundle)
      tableView!.register(dynamicLabelTextFieldNib, forCellReuseIdentifier: "dynamic_label_text_field")
      let addTextFieldNib = UINib(nibName: "AddTextFieldTableViewCell", bundle: frameworkBundle)
      tableView!.register(addTextFieldNib, forCellReuseIdentifier: "add_text_field")
      let submitNib = UINib(nibName: "SubmitButtonTableViewCell", bundle: frameworkBundle)
